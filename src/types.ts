...
> = {
    ...
    deleteComment?: Resolver<
        Maybe<ResolversTypes["CommentResponse"]>,
        ParentType,
        ContextType,
    ...
    >;
    signIn?: Resolver<
        Maybe<ResolversTypes["SignInUserResponse"]>,
        ParentType,
        ContextType,
...
> = {
    ...
    >;
    getLikesPost?: Resolver<
        ResolversTypes["Int"],
        ParentType,
        ContextType,
        RequireFields<QueryGetLikesPostArgs, "postId">
    >;
    post?: Resolver<
...
export type SignInUserResponseResolvers<
    ContextType = DataSourceContext,
    ParentType extends ResolversParentTypes["SignInUserResponse"] = ResolversParentTypes["SignInUserResponse"]
> = {
    code?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
    message?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
    success?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
